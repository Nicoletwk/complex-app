...
export default class Search {
    ...
    renderResultsHTML(posts){
      if (posts.length) {
        ...
        this.resultsArea.innerHTML = `<p class = "alert alert-danger text-center shadow-sm">Sorry, there's no results for that search!</p>`
      }
      this.hideLoaderIcon()
    ...
    openOverlay() {
        ...
        setTimeout(() => this.inputField.focus(), 750)
    }
